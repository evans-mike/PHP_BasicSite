...
if ($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    $format = trim(filter_input(INPUT_POST,"filter",FILTER_SANITIZE_STRING));
    $genre = trim(filter_input(INPUT_POST,"gnere",FILTER_SANITIZE_STRING));
    ...
    <form method="post" action="suggest.php">
        <table>
            ...
            <tr style="display:none">
                ...
                <p>Please leave this fiel blank.</p></td>
            </tr>
        </table>
